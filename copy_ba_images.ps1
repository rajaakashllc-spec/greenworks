...
Copy-Item -LiteralPath $files[0].FullName -Destination "$dest\user_ba_1.jpg" -Force
Copy-Item -LiteralPath $files[1].FullName -Destination "$dest\user_ba_2.jpg" -Force
Copy-Item -LiteralPath $files[2].FullName -Destination "$dest\user_ba_3.jpg" -Force

Write-Host "Successfully copied 3 user uploaded Before & After images!"
